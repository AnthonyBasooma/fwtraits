...
- [`fw_visualize()`](https://anthonybasooma.github.io/fwtraits/reference/fw_visualize.md)provides
  graphical display of the information obtained from the database.
