...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/fwtraits?color=orange)](https://cran.r-project.org/package=fwtraits)
...
Basooma, A., Borgwardt, F., Domisch, S., Buurman, M., Bremerich, V., Recinos Brizuela, S., Tschikof, M., Hein, T., & Schmidt-Kloiber, A. (2025). Introducing fwtraits – an R package for obtaining freshwater biodiversity trait information. Basic and Applied Ecology, 8, 81-91. https://doi.org/10.1016/j.baae.2025.10.010
...
Freshwater Ecology Information Platform. (2025). FWE-API 2 – Documentation of freshwaterecology.info. Retrieved November 20, 2025, from https://www.freshwaterecology.info/fweapi2docu.php
